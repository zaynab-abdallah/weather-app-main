...
import { CurrentWeather as CurrentWeatherType, DailyWeather, Location, Units } from '@/types'
import { convertTemperature, getTemperatureUnit, weatherIcons, formatDate, formatTime, getWeatherClass } from '@/lib/utils'
...
export default function CurrentWeather({ current, daily, location, units }: CurrentWeatherProps) {
  ...
  return (
    <section className={`current-weather ${weatherClass}`}>
      ...
      {daily.sunrise && daily.sunrise[0] && daily.sunset && daily.sunset[0] && (
